...
document.querySelector("form").addEventListener("submit", async function(event) {
  ...
  const outputAtmount = parseFloat(document.getElementById("withdrawal-amount").value);
  ...
  if(document.getElementById("withdrawal-amount").value.length != 0){
    await _declarations_dbank__WEBPACK_IMPORTED_MODULE_0__.dbank.withdraw(outputAtmount);
  }
